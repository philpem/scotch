 ...
 * original Eidos DOS player did). This decoder is implemented from scratch,
 * strictly from the behavioural specification in docs/spec/eidos-escape.md
 * (§ Type 122); no existing decoder implementation was consulted.
 *
